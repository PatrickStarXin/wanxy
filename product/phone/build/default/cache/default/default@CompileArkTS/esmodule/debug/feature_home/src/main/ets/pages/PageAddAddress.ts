...
import { TakeOutAddressInfo } from "@normalized:N&&&feature_home/src/main/ets/model/TakeOutAddressInfo&1.0.0";
import { PreferenceUtil } from "@normalized:N&&&common_utils/Index&1.0.0";
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    const forEachItemGenFunction = (_item, index: number) => {
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Button.backgroundColor(this.labelSelect === index ? { "id": 134217761, "type": 10001, params: [], "bundleName": "wanxy.food.com", "moduleName": "phone" } : { "id": 134217758, "type": 10001, params: [], "bundleName": "wanxy.food.com", "moduleName": "phone" });
                            Button.borderColor({ "id": 134217758, "type": 10001, params: [], "bundleName": "wanxy.food.com", "moduleName": "phone" });
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Toggle.switchPointColor({ "id": 125831127, "type": 10001, params: [], "bundleName": "wanxy.food.com", "moduleName": "phone" });
