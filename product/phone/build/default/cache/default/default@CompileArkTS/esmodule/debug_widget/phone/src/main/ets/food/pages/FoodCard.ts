...
class FoodDemoCard extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 134217750, "type": 20000, params: [], "bundleName": "wanxy.food.com", "moduleName": "phone" });
        }, Image);
        Column.pop();
        Row.pop();
    }
...
loadEtsCard(new FoodDemoCard(undefined, {}), "wanxy.food.com/phone/ets/food/pages/FoodCard");
