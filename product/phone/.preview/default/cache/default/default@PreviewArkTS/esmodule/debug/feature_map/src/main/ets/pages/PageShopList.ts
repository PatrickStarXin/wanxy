...
import { getShopByName, ShopDetailList } from "@bundle:com.atomicservice.5765880207855620561/phone@feature_map/ets/model/ShopModelData";
import type { ShopDetail } from "@bundle:com.atomicservice.5765880207855620561/phone@feature_map/ets/model/ShopModelData";
import { MapUtil } from "@bundle:com.atomicservice.5765880207855620561/phone@feature_map/ets/utils/MapUtil";
...
export class PageShopList extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__closeMapImg = new ObservedPropertyObjectPU({ "id": 134217776, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" }, this, "closeMapImg");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(95:7)", "feature_map");
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    If.create();
                    ...
                    if (this.closeMap === "收起地图") {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Stack.create();
                                Stack.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(98:11)", "feature_map");
                                Stack.width('100%');
                                Stack.height('40%');
                            }, Stack);
                            {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(103:9)", "feature_map");
                    Row.margin({ top: 10, bottom: 10 });
                    Row.onClick(() => {
                        this.closeMap = this.closeMap === "收起地图" ? "展开地图" : "收起地图";
                        this.closeMapImg =
                            this.closeMapImg === { "id": 134217776, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" } ? { "id": 134217763, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" } : { "id": 134217776, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" };
                    });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(this.closeMap);
                    Text.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(104:11)", "feature_map");
                    Text.fontSize(12);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(105:11)", "feature_map");
                    Image.height(12);
                }, Image);
                Row.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 门店
                    Scroll.create();
                    Scroll.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(114:9)", "feature_map");
                    // 门店
                    ...
                    Scroll.width('100%');
                    // 门店
                    Scroll.backgroundColor({ "id": 134217759, "type": 10001, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                    // 门店
                    Scroll.padding(16);
                    // 门店
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(115:11)", "feature_map");
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ForEach.create();
                    const forEachItemGenFunction = _item => {
                        const detail = _item;
                        {
                            ...
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ...
                                ListItem.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(117:15)", "feature_map");
                            };
                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                itemCreation(elmtId, isInitialRender);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Stack.create({ alignContent: Alignment.BottomEnd });
                                    Stack.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(118:17)", "feature_map");
                                }, Stack);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(119:19)", "feature_map");
                                    Row.borderWidth(detail.name === this.preChooseShop ? 1 : 0);
                                    Row.borderRadius(16);
                                    Row.borderColor({ "id": 134217760, "type": 10001, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(120:21)", "feature_map");
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(121:23)", "feature_map");
                                    Text.width('100%');
                                }, Text);
                                Text.pop();
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create(detail.addr);
                                    Text.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(122:23)", "feature_map");
                                    Text.width('100%');
                                    Text.fontColor(Color.Gray);
                                    Text.fontSize(12);
                                    Text.margin({ top: 5 });
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(123:23)", "feature_map");
                                    Text.width('100%');
                                    Text.fontColor(Color.Gray);
                                    Text.fontSize(12);
                                    Text.margin({ top: 5 });
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(128:23)", "feature_map");
                                    Row.width('100%');
                                    Row.margin({ top: 15 });
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Image.create({ "id": 134217778, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                                    Image.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(129:25)", "feature_map");
                                    Image.height(25);
                                    Image.width(25);
                                    Image.onClick(() => {
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Image.create({ "id": 134217766, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                                    Image.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(139:25)", "feature_map");
                                    Image.height(25);
                                    Image.width(25);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    if (detail.name === this.preChooseShop) {
                                        this.ifElseBranchUpdateFunction(0, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Image.create({ "id": 134217767, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                                                Image.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(155:27)", "feature_map");
                                                Image.height(25);
                                                Image.width(25);
                                                Image.margin({ left: 20 });
                                            }, Image);
                                        ...
                                        this.ifElseBranchUpdateFunction(1, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Image.create({ "id": 134217765, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                                                Image.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(157:27)", "feature_map");
                                                Image.height(25);
                                                Image.width(25);
                                                Image.margin({ left: 20 });
                                            }, Image);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(164:21)", "feature_map");
                                    Column.layoutWeight(3);
                                }, Column);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(165:23)", "feature_map");
                                    Row.height('60%');
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create("去下单");
                                    Text.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(166:25)", "feature_map");
                                    Text.margin({ left: 20 });
                                    Text.onClick(() => {
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    if (detail.name === this.preChooseShop) {
                                        this.ifElseBranchUpdateFunction(0, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Image.create({ "id": 134217769, "type": 20000, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "phone" });
                                                Image.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(208:21)", "feature_map");
                                                Image.width(50);
                                                Image.height(50);
            ...
            NavDestination.debugLine("feature/feature_map/src/main/ets/pages/PageShopList.ets(94:5)", "feature_map");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
