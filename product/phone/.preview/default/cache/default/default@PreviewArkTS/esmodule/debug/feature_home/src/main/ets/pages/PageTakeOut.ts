        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Stack.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(54:7)", "feature_home");
                    Stack.width('90%');
                    Stack.height('100%');
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    List.create();
                    List.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(56:9)", "feature_home");
                    ...
                    const forEachItemGenFunction = (_item, index: number) => {
                        const addressInfo = _item;
                        {
                            ...
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ...
                                ListItem.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(58:13)", "feature_home");
                            };
                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                itemCreation(elmtId, isInitialRender);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(59:15)", "feature_home");
                                    Column.height(80);
                                    Column.width('100%');
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(60:17)", "feature_home");
                                    Row.width('100%');
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(61:19)", "feature_home");
                                }, Text);
                                Text.pop();
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create(addressInfo.addressDetail);
                                    Text.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(62:19)", "feature_home");
                                    Text.margin({ left: 5 });
                                }, Text);
                                Text.pop();
                                Row.pop();
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(65:17)", "feature_home");
                                    Row.width('100%');
                                    Row.justifyContent(FlexAlign.Start);
                                    Row.layoutWeight(1);
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(66:19)", "feature_home");
                                    Text.fontColor(Color.Gray);
                                }, Text);
                                Text.pop();
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create(addressInfo.phone);
                                    Text.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(67:19)", "feature_home");
                                    Text.fontColor(Color.Gray);
                                    Text.margin({ left: 5 });
                                }, Text);
                                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(95:9)", "feature_home");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(' + 新增地址');
                    Text.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(96:11)", "feature_home");
                }, Text);
                Text.pop();
                Button.pop();
                Stack.pop();
            ...
            NavDestination.debugLine("feature/feature_home/src/main/ets/pages/PageTakeOut.ets(53:5)", "feature_home");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
