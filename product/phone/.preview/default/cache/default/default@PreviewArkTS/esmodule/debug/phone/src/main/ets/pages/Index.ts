...
import { NavRouterMap, RouterModule, NavStackMap } from "@bundle:com.atomicservice.5765880207855620561/phone@router_manage/Index";
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("product/phone/src/main/ets/pages/Index.ets(29:5)", "phone");
...
registerNamedRoute(() => new Index(undefined, {}), "", { bundleName: "com.atomicservice.5765880207855620561", moduleName: "phone", pagePath: "pages/Index", pageFullPath: "product/phone/src/main/ets/pages/Index", integratedHsp: "false", moduleType: "followWithHap" });
