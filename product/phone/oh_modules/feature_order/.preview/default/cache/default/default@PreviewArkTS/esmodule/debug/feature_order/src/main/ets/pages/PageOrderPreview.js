 ...
 */
import { getBuyFoods } from '@bundle:com.atomicservice.5765880207855620561/feature_order@feature_food/Index';
...
import { OrderDetail, OrderStatus } from '@bundle:com.atomicservice.5765880207855620561/feature_order/ets/model/OrderInfo';
...
export class PageOrderPreview extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__chooseShop = this.createLocalStorageLink("chooseShop", "", "chooseShop");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                Stack.pop();
            }, { moduleName: "feature_order", pagePath: "feature/feature_order/src/main/ets/pages/PageOrderPreview" });
            NavDestination.title("订单结算");
            NavDestination.backgroundColor({ "id": 100663311, "type": 10001, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "feature_order" });
            ...
            if (this.orderType == OrderType.DINE_IN) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Toggle.selectedColor({ "id": 100663312, "type": 10001, params: [], "bundleName": "com.atomicservice.5765880207855620561", "moduleName": "feature_order" });
...
registerNamedRoute(() => new PageOrderPreview(undefined, {}), "", { bundleName: "com.atomicservice.5765880207855620561", moduleName: "feature_order", pagePath: "pages/PageOrderPreview", pageFullPath: "feature/feature_order/src/main/ets/pages/PageOrderPreview", integratedHsp: "false", moduleType: "followWithHap" });
(function () {
    if (typeof NavigationBuilderRegister === "function") {
        NavigationBuilderRegister("PageOrderPreview", wrapBuilder(PageOrderPreviewBuilder));
    }
})();
//# sourceMappingURL=PageOrderPreview.js.map