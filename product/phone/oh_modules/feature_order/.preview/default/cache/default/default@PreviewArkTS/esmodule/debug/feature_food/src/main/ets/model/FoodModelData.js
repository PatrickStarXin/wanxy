...
export const FoodCategoryListData1 = [
    '粉丝福利', '多人套餐', '田园时蔬', '单人套餐', '招牌必点', '小份尝鲜', '湘味小炒', '主食小吃'
];
export const FoodCategoryListData2 = [
    '时令上新', '热饮推荐', '清爽果茶', '醇香奶茶', '主食小吃'
];
export const FoodListData1 = [
    {
        "category": "粉丝福利",
        "list": [
            {
...
export function getCategoryListByShop(chooseShop) {
    return chooseShop === "南京雨花客厅店" ? FoodCategoryListData1 : FoodCategoryListData2;
}
export function getFoodListByShop(chooseShop) {
    return chooseShop === "南京雨花客厅店" ? FoodListData1 : FoodListData2;
}
//# sourceMappingURL=FoodModelData.js.map