 ...
 */
import { AnimatedMap, NavRouterMap, NavStackMap, RouterModule } from '@bundle:com.atomicservice.6917586311984927931/feature_food@router_manage/Index';
import { getCategoryListByShop, getFoodListByShop } from '@bundle:com.atomicservice.6917586311984927931/feature_food/ets/model/FoodModelData';
import abilityAccessCtrl from '@ohos:abilityAccessCtrl';
import geoLocationManager from '@ohos:geoLocationManager';
import { addition, Logger, OrderType, PermissionsUtil, PreferenceUtil, subtraction } from '@bundle:com.atomicservice.6917586311984927931/feature_food@common_utils/Index';
import { ShopDetailList } from '@bundle:com.atomicservice.6917586311984927931/feature_food@feature_map/Index';
...
export class FoodCategory extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__singleSelectCapsuleOptions = new ObservedPropertyObjectPU(SegmentButtonOptions.capsule({
            ...
            selectedBackgroundColor: { "id": 33554448, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(202:7)", "feature_food");
                    Column.width('100%');
                    Column.height('calc(100% - 105vp)');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(203:9)", "feature_food");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create("美食列表");
                    Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(204:11)", "feature_food");
                    Text.fontWeight(600);
                    Text.fontSize(18);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(207:9)", "feature_food");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.orderType === OrderType.TAKEOUT) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(209:13)", "feature_food");
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(210:15)", "feature_food");
                                Row.onClick(() => {
                                    RouterModule.push({
                                        stackName: NavStackMap.MAIN_STACK,
                                        url: NavRouterMap.PAGE_TAKE_OUT,
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(211:17)", "feature_food");
                                Text.margin({ left: 15 });
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 33554459, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                                Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(212:17)", "feature_food");
                                Image.height(25);
                                Image.width(25);
                                Image.margin({ left: 5 });
                            }, Image);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(220:15)", "feature_food");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 33554450, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                                Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(221:17)", "feature_food");
                                Image.height(15);
                                Image.width(15);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(229:17)", "feature_food");
                                Text.fontSize(12);
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(234:13)", "feature_food");
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                If.create();
                                if (!this.isGetLocation) {
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Row.create();
                                            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(236:17)", "feature_food");
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Text.create("开启定位");
                                            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(237:19)", "feature_food");
                                            Text.onClick(async () => {
                                    ...
                                    this.ifElseBranchUpdateFunction(1, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Row.create();
                                            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(247:17)", "feature_food");
                                            Row.onClick(() => {
                                                RouterModule.push({
                                                    stackName: NavStackMap.MAIN_STACK,
                                                    url: NavRouterMap.PAGE_SHOP_LIST,
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(248:19)", "feature_food");
                                            Text.margin({ left: 15 });
                                        }, Text);
                                        Text.pop();
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Image.create({ "id": 33554459, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                                            Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(249:19)", "feature_food");
                                            Image.height(25);
                                            Image.width(25);
                                            Image.margin({ left: 5 });
                                        }, Image);
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(257:17)", "feature_food");
                                            Text.fontSize(12);
                                            Text.fontColor(Color.Gray);
                                        }, Text);
                                        Text.pop();
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            }, undefined, elmtId, () => { }, { page: "feature/feature_food/src/main/ets/components/FoodCategory.ets", line: 263, col: 11 });
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Stack.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(274:9)", "feature_food");
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(275:11)", "feature_food");
                    Row.width('100%');
                    Row.layoutWeight(1);
                }, Row);
                // 左侧导航栏
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    List.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(279:13)", "feature_food");
                    // 右侧详情
                    List.height('100%');
                    // 右侧详情
                    ...
                    const forEachItemGenFunction = _item => {
                        const item = _item;
                        {
                            ...
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ...
                                ListItem.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(281:17)", "feature_food");
                            };
                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                itemCreation(elmtId, isInitialRender);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(282:19)", "feature_food");
                                }, Column);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.chickShop) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(300:13)", "feature_food");
                                Column.width('100%');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(301:15)", "feature_food");
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(302:17)", "feature_food");
                                Row.justifyContent(FlexAlign.End);
                                Row.width('100%');
                                Row.height(40);
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 33554444, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                                Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(303:19)", "feature_food");
                                Image.width(14);
                                Image.height(14);
                                Image.onClick(() => {
                                    this.buyFoods.clear();
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create("清空");
                                Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(309:19)", "feature_food");
                                Text.fontSize(14);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Divider.create();
                                Divider.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(318:17)", "feature_food");
                            }, Divider);
                ...
                Stack.pop();
                Column.pop();
            }, { moduleName: "feature_food", pagePath: "feature/feature_food/src/main/ets/components/FoodCategory" });
            NavDestination.hideTitleBar(true);
            NavDestination.backgroundColor(Color.White);
            NavDestination.margin({ top: this.topRectHeight });
            NavDestination.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(201:5)", "feature_food");
        }, NavDestination);
        NavDestination.pop();
    }
    titleBuilder(item, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(337:5)", "feature_food");
            Row.width('100%');
            Row.padding({ top: 16, bottom: 16 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(item);
            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(338:7)", "feature_food");
            Text.fontSize(18);
            Text.fontColor({ "id": 33554448, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(339:7)", "feature_food");
        }, Blank);
        Blank.pop();
        Row.pop();
    }
    barBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(347:5)", "feature_food");
            Column.height('100%');
            Column.width(100);
            Column.backgroundColor({ "id": 33554447, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
            const forEachItemGenFunction = (_item, index) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(349:9)", "feature_food");
                    Column.backgroundColor(this.currentIndex === index ? Color.White : null);
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create({ space: 4 });
                    Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(350:11)", "feature_food");
                    Row.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create(this.currentIndex === index ? { "id": 33554439, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" } : { "id": 33554434, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                    Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(351:13)", "feature_food");
                    Image.width(10);
                    Image.height(10);
                }, Image);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(item);
                    Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(354:13)", "feature_food");
                    Text.fontColor(this.currentIndex === index ? { "id": 33554448, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" } : Color.Black);
                    Text.fontSize(12);
                }, Text);
                Text.pop();
                Row.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Divider.create();
                    Divider.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(365:11)", "feature_food");
                    Divider.height(1);
                }, Divider);
                Column.pop();
            };
    ...
    foodListBuilder(category, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create();
            List.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(373:5)", "feature_food");
        }, List);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ForEach.create();
            const forEachItemGenFunction = _item => {
                const foodDetail = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ListItem.create(deepRenderFunction, true);
                        ListItem.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(375:9)", "feature_food");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(376:11)", "feature_food");
                            Row.height(100);
                            Row.onClick(() => {
                                RouterModule.push({
                                    stackName: NavStackMap.MAIN_STACK,
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Image.create({ "id": -1, "type": -1, params: [foodDetail.pic], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                            Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(377:13)", "feature_food");
                            Image.height(60);
                            Image.width(60);
                        }, Image);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Column.create();
                            Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(378:13)", "feature_food");
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.fontSize(12);
                            Text.fontColor({ "id": 33554446, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                            Text.width('100%');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Text.create(foodDetail.label);
                            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(381:15)", "feature_food");
                            Text.fontSize(12);
                            Text.width('100%');
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(382:15)", "feature_food");
                            Row.width('100%');
                            Row.height(30);
                            Row.justifyContent(FlexAlign.SpaceBetween);
                        }, Row);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(383:17)", "feature_food");
                            Text.fontWeight(600);
                            Text.fontSize(16);
                        }, Text);
                        Text.pop();
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(385:17)", "feature_food");
                        }, Row);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.buyFoods.size > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create();
                        List.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(411:7)", "feature_food");
                    }, List);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ForEach.create();
                        const forEachItemGenFunction = _item => {
                            const foodDetail = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(413:11)", "feature_food");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(414:13)", "feature_food");
                                        Row.width('100%');
                                        Row.height(80);
                                        Row.borderWidth({ top: 2 });
                                        Row.borderColor({ "id": 33554445, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                                        Row.onClick(() => {
                                            RouterModule.push({
                                                stackName: NavStackMap.MAIN_STACK,
                                                url: NavRouterMap.PAGE_FOOD_DETAIL,
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create({ "id": -1, "type": -1, params: [foodDetail.pic], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
                                        Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(415:15)", "feature_food");
                                        Image.height(40);
                                        Image.width(40);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create();
                                        Column.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(416:15)", "feature_food");
                                        Column.justifyContent(FlexAlign.Start);
                                        Column.padding({ top: 5, bottom: 5 });
                                        Column.margin({ left: 10 });
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(417:17)", "feature_food");
                                        Row.width('100%');
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(foodDetail.title);
                                        Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(418:19)", "feature_food");
                                    }, Text);
                                    Text.pop();
                                    Row.pop();
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(421:17)", "feature_food");
                                        Row.width('100%');
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(foodDetail.label);
                                        Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(422:19)", "feature_food");
                                        Text.fontSize(12);
                                    }, Text);
                                    Text.pop();
                                    Row.pop();
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(425:17)", "feature_food");
                                        Row.width('100%');
                                        Row.height(30);
                                        Row.justifyContent(FlexAlign.SpaceBetween);
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(426:19)", "feature_food");
                                        Text.fontSize(16);
                                        Text.fontWeight(600);
                                    }, Text);
                                    Text.pop();
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(428:19)", "feature_food");
                                        Row.justifyContent(FlexAlign.SpaceBetween);
                                        Row.margin({ right: 65 });
                                    }, Row);
                                    this.buyNumBuilder.bind(this)(foodDetail);
    ...
    buyNumBuilder(foodDetail, parent = null) {
            ...
            if (this.buyFoods.get(foodDetail.id)) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(463:7)", "feature_food");
                        Image.width(25);
                        Image.height(25);
            ...
            if (this.buyFoods.get(foodDetail.id)) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(492:7)", "feature_food");
                        Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(495:5)", "feature_food");
            Image.width(25);
            Image.height(25);
            Image.objectFit(ImageFit.Fill);
            Image.onClick(() => {
    ...
    shopBuilder(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(513:5)", "feature_food");
            Row.height(50);
            Row.width('100%');
            Row.backgroundColor(Color.White);
            Row.justifyContent(FlexAlign.SpaceBetween);
            Row.borderWidth({ top: 1 });
            Row.borderColor({ "id": 33554447, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
            Row.visibility(this.choosePrice === 0 ? Visibility.Hidden : Visibility.Visible);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(514:7)", "feature_food");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 33554465, "type": 20000, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
            Image.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(515:9)", "feature_food");
            Image.height(40);
            Image.width(40);
            Image.margin({ left: 15 });
            Image.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create();
            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(519:9)", "feature_food");
            Text.fontSize(16);
        }, Text);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Span.create("￥");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Span.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(521:11)", "feature_food");
        }, Span);
        Text.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(525:7)", "feature_food");
            Row.justifyContent(FlexAlign.Center);
            Row.backgroundColor({ "id": 33554448, "type": 10001, params: [], "bundleName": "com.atomicservice.6917586311984927931", "moduleName": "feature_food" });
            Row.height('80%');
            Row.width(120);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("选好了");
            Text.debugLine("feature/feature_food/src/main/ets/components/FoodCategory.ets(526:9)", "feature_food");
...
registerNamedRoute(() => new FoodCategory(undefined, {}), "", { bundleName: "com.atomicservice.6917586311984927931", moduleName: "feature_food", pagePath: "components/FoodCategory", pageFullPath: "feature/feature_food/src/main/ets/components/FoodCategory", integratedHsp: "false", moduleType: "followWithHap" });
